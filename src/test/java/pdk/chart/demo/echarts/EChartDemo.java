...
public class EChartDemo extends ApplicationFrame implements ActionListener, TreeSelectionListener, ChangeListener {
    ...
    public EChartDemo(String title) {
        super(title);
    ...
    private TreeModel createTreeModel() {
        DefaultMutableTreeNode root = new DefaultMutableTreeNode("Chart");
...
//    }
    ...
    private MutableTreeNode createLineChartsNode() {
        ...
        root.add(createNode(LineSimple.class, "LineSimple.java"));
...
//    }
    ...
    private void displayDescription(String fileName) {
        URL descriptionURL = EChartDemo.class.getResource(fileName);
...
//                this.updateSourceCodePanel((String) null);
    ...
    static void main() {
        SwingUtilities.invokeLater(() -> {
            ...
            EChartDemo demo = new EChartDemo("Demo Collection");
            demo.pack();
    ...
    static class PDFExportTask implements Runnable {
        ...
        public PDFExportTask(Chart chart, int width, int height, File file) {
            ...
            chart.setPadding(new RectangleInsets(2.0, 2.0F, (double) 2.0F, (double) 2.0F));
        }

        public void run() {
            try {
                EChartDemo.saveChartAsPDF(this.file, this.chart, this.width, this.height);
            } catch (IOException e) {
                e.printStackTrace();
            }
    ...
    static class DisplayDemo implements Runnable {
        ...
        private EChartDemo app;
        private DemoDescription demoDescription;

        public DisplayDemo(EChartDemo app, DemoDescription d) {
            this.app = app;
