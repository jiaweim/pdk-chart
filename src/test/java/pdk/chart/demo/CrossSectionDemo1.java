...
import pdk.chart.data.general.DefaultHeatMapDataset;
import pdk.chart.data.general.HeatMapDataset;
import pdk.chart.data.general.HeatMapUtils;
...
/**
 * A demo originally written for a client to show how to synchronise
 * related charts in a Swing user interface.
 *
 * @author Jiawei Mao
 * @version 1.0.0
 * @since 23 Jun 2026, 12:56 PM
 */
public class CrossSectionDemo1 extends ApplicationFrame {
    ...
    private static HeatMapDataset createMapDataset() {
        DefaultHeatMapDataset d = new DefaultHeatMapDataset(501, 501,
                -250.0, 250.0, -250.0, 250.0);

        for (int i = 0; i < 501; ++i) {
            for (int j = 0; j < 501; ++j) {
                d.setZValue(i, j, Math.sin(Math.sqrt(i * j) / 10.0));
            }
        }
    ...
    static class MyDemoPanel extends DemoPanel implements ChangeListener, ChartChangeListener {
        ...
        private Chart subchart1;
        private Chart subchart2;
        ...
        public MyDemoPanel() {
            ...
            ChartPanel subchart1Panel = new ChartPanel(this.subchart1);
            ...
            ChartPanel subchart2Panel = new ChartPanel(this.subchart2);
            ...
            slider2Panel.add(this.slider2, "North");
            this.add(slider1Panel, "East");
            this.add(slider2Panel, "South");
        ...
        private Chart createChart(XYDataset dataset) {
            ...
            yAxis.setLowerMargin(0.0F);
            yAxis.setUpperMargin(0.0F);
            return chart;
        }
    }
}
