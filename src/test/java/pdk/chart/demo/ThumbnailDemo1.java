...
public class ThumbnailDemo1 extends ApplicationFrame {
    ...
    private static CategoryDataset createDataset3() {
        DefaultCategoryDataset dataset = new DefaultCategoryDataset();
        dataset.addValue(81.0F, "Against all torture", "Italy");
        dataset.addValue(72.0F, "Against all torture", "Great Britain");
        dataset.addValue(58.0F, "Against all torture", "USA");
        dataset.addValue(48.0F, "Against all torture", "Israel");
        dataset.addValue(43.0F, "Against all torture", "Russia");
        dataset.addValue(23.0F, "Against all torture", "India");
        dataset.addValue(59.0F, "Against all torture", "Average (*)");
        dataset.addValue(5.0F, "-", "Italy");
        dataset.addValue(4.0F, "-", "Great Britain");
        dataset.addValue(6.0F, "-", "USA");
        dataset.addValue(9.0F, "-", "Israel");
        dataset.addValue(20.0F, "-", "Russia");
        dataset.addValue(45.0F, "-", "India");
        dataset.addValue(12.0F, "-", "Average (*)");
        dataset.addValue(14.0F, "Some degree permissible", "Italy");
        dataset.addValue(24.0F, "Some degree permissible", "Great Britain");
        dataset.addValue(36.0F, "Some degree permissible", "USA");
        dataset.addValue(43.0F, "Some degree permissible", "Israel");
        dataset.addValue(37.0F, "Some degree permissible", "Russia");
        dataset.addValue(32.0F, "Some degree permissible", "India");
        dataset.addValue(29.0F, "Some degree permissible", "Average (*)");
        return dataset;
    }
    ...
    private static Chart createChart3(CategoryDataset dataset) {
        ...
        tt.setMargin(0.0F, 0.0F, 4.0F, 4.0F);
    ...
    private static CategoryDataset createDataset6() {
        ...
        dataset.addValue(1520.0, "Classes", "SDK 1.2");
        dataset.addValue(1842.0, "Classes", "SDK 1.3");
        dataset.addValue(2991.0, "Classes", "SDK 1.4");
        return dataset;
    }
