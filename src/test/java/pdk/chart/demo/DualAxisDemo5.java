...
public class DualAxisDemo5 extends ApplicationFrame {
    public DualAxisDemo5(String title) {
        ...
        Chart chart = createChart(dataset1, dataset2);
    ...
    private static CategoryDataset createDataset1() {
        ...
        dataset.addValue((Number) null, series2, category1);
        dataset.addValue((Number) null, series2, category2);
        dataset.addValue((Number) null, series2, category3);
        dataset.addValue((Number) null, series2, category4);
        return dataset;
    }
    ...
    public static void main(String[] args) {
        DualAxisDemo5 demo = new DualAxisDemo5("Chart: DualAxisDemo5.java");
        demo.pack();
