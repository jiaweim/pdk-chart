...
public class CombinedXYPlotDemo1 extends ApplicationFrame {
    ...
    private static Chart createCombinedChart() {
        ...
        XYBarRenderer renderer2 = new XYBarRenderer() {
            public Paint getItemPaint(int series, int item) {
                ...
                return dataset.getYValue(series, item) >= (double)0.0F ? Color.RED : Color.GREEN;
            }
        };
        ...
        Chart chart = new Chart("United States Public Debt", Chart.DEFAULT_TITLE_FONT, cplot, false);
        TextTitle source = new TextTitle("Source: http://www.publicdebt.treas.gov/opd/opdhisms.htm", new Font("Dialog", 0, 10));
    ...
    private static IntervalXYDataset createDataset1() {
        ...
        series1.add(new Month(10, 1990), 3274.95);
        series1.add(new Month(11, 1990), 3330.685);
        series1.add(new Month(12, 1990), 3364.82);
        ...
        series1.add(new Month(9, 1994), (double)4692.75F);
        series1.add(new Month(10, 1994), 4734.167);
        series1.add(new Month(11, 1994), 4778.52);
        series1.add(new Month(12, 1994), 4800.15);
        ...
        series1.add(new Month(11, 1995), 4989.33);
        ...
        series1.add(new Month(10, 1996), 5247.32);
        ...
        series1.add(new Month(3, 1997), 5380.89);
        ...
        series1.add(new Month(8, 1997), 5404.42);
        ...
        series1.add(new Month(4, 1999), 5585.84);
        series1.add(new Month(5, 1999), 5604.198);
        series1.add(new Month(6, 1999), 5638.78);
        ...
        series1.add(new Month(11, 1999), 5693.6);
        ...
        series1.add(new Month(5, 2000), 5647.17);
        ...
        series1.add(new Month(3, 2001), 5773.74);
    ...
    private static IntervalXYDataset createDataset2() {
        ...
        series1.add(new Month(4, 1994), 314.62);
        ...
        series1.add(new Month(10, 1998), 132.03);
        ...
        series1.add(new Month(12, 2000), (double)-113.875F);
        series1.add(new Month(1, 2001), 4.786);
        series1.add(new Month(2, 2001), 0.526);
        series1.add(new Month(3, 2001), 0.348);
        series1.add(new Month(4, 2001), -23.76);
        ...
        series1.add(new Month(5, 2002), 363.15);
        ...
        series1.add(new Month(12, 2004), 598.18);
        ...
        series1.add(new Month(7, 2005), 571.05);
        ...
        series1.add(new Month(12, 2005), 574.27);
        ...
        series1.add(new Month(12, 2006), 509.81);
    ...
    public static void main(String[] args) {
        CombinedXYPlotDemo1 demo = new CombinedXYPlotDemo1("CombinedXYPlotDemo1.java");
        demo.pack();
