...
public class BarChartDemo5 extends ApplicationFrame {
    ...
    private static Chart createChart(CategoryDataset dataset) {
        Chart chart = JChart.bar("Prison Population Rates - Selected Countries", "Country", "Prisoners Per 100,000 National Population", dataset, PlotOrientation.HORIZONTAL, false, true, false);
