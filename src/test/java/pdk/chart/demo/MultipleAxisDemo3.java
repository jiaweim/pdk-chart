...
public class MultipleAxisDemo3 extends ApplicationFrame {
    ...
    private static Chart createChart() {
        ...
        Chart chart = JChart.timeLine("Multiple Axis Demo 3", "Time of Day", "Primary Range Axis", dataset1, true, true, false);
    ...
    public static void main(String[] args) {
        MultipleAxisDemo3 demo = new MultipleAxisDemo3("Chart: MultipleAxisDemo3.java");
        demo.pack();
