...
public class XYStepRendererDemo2 extends ApplicationFrame {
    ...
    private static Chart createChart(XYDataset dataset) {
        Chart chart = ChartFactory.createXYLineChart("XYStepRendererDemo2", "X", "Y", dataset, PlotOrientation.VERTICAL, true, true, false);
        ...
        renderer.setDefaultItemLabelFont(new Font("Dialog", 1, 14));
    ...
    public static void main(String[] args) {
        XYStepRendererDemo2 demo = new XYStepRendererDemo2("Chart: XYStepRendererDemo2.java");
        demo.pack();
