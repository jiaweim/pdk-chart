...
public class PieChartDemo5 extends ApplicationFrame {
    ...
    public static JPanel createDemoPanel() {
        ...
        Chart chart1 = new PieChart(dataset, "Chart 1", false, false);
        chart1.addSubtitle(new TextTitle("setCircular(true);", new Font("Dialog", Font.PLAIN, 12)));
        PiePlot plot1 = (PiePlot) chart1.getPlot();
        plot1.setCircular(true);
        plot1.setInteriorGap(0.04);
        plot1.setMaximumLabelWidth(0.2);
        Chart chart2 = new PieChart(dataset, "Chart 2", false, false);
        chart2.addSubtitle(new TextTitle("setCircular(false);", new Font("Dialog", Font.PLAIN, 12)));
    ...
    static void main() {
        PieChartDemo5 demo = new PieChartDemo5("PieChartDemo5.java");
        demo.pack();
