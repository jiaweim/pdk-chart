...
public class DifferenceChartDemo2 extends ApplicationFrame {
    ...
    private static Chart createChart(XYDataset dataset) {
        ...
        bst.setGradientPaintTransformer(new StandardGradientPaintTransformer(GradientPaintTransformType.HORIZONTAL));
    ...
    public static void main(String[] args) {
        DifferenceChartDemo2 demo = new DifferenceChartDemo2("Chart: DifferenceChartDemo2.java");
        demo.pack();
