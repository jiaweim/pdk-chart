...
public class YIntervalRenderer extends AbstractXYItemRenderer
     ...
     */
    public YIntervalRenderer seriesFillPaint(int series, Paint paint) {
     ...
     */
    public YIntervalRenderer seriesStroke(int series, Stroke stroke) {
     ...
     */
    public YIntervalRenderer defaultItemLabelsVisible(boolean visible) {
     ...
     * @param generator the generator ({@code null} permitted).
     */
    public YIntervalRenderer defaultItemLabelGenerator(XYItemLabelGenerator generator) {
