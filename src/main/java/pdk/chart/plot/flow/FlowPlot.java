...
import pdk.chart.entity.FlowEntity;
import pdk.chart.entity.NodeEntity;
import pdk.chart.util.Args;
import pdk.chart.util.PaintUtils;
import pdk.chart.labels.FlowLabelGenerator;
import pdk.chart.labels.StandardFlowLabelGenerator;
 ...
 */
public class FlowPlot<K extends Comparable<K>> extends Plot
