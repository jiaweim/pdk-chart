 ...
 * @see Plot
 */
public class Chart implements ShowChart, Drawable, TitleChangeListener,
    ...
    public Chart(String title, Plot plot) {
        this(title, Chart.DEFAULT_TITLE_FONT, plot, true);
    }
    ...
    public void setTitle(String text) {
        if (text != null) {
            if (this.title == null) {
                setTitle(new TextTitle(text, Chart.DEFAULT_TITLE_FONT));
            } else {
