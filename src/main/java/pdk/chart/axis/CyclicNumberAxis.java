...
public class CyclicNumberAxis extends NumberAxis {
     ...
     * @param size   the size.
     * @param notify notify?
     * @see pdk.chart.axis.ValueAxis#setAutoRangeMinimumSize(double,
     * boolean)
     */
    @Override
     ...
     * @see pdk.chart.axis.ValueAxis#setFixedAutoRange(double)
     */
    @Override
     ...
     * @param notify           notify?
     * @see pdk.chart.axis.ValueAxis#setRange(Range, boolean, boolean)
     */
    @Override
